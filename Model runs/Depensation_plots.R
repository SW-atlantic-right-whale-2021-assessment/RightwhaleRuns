...
plot_suplus_prod(list(sir_base2[[1]]), file_name = file_name, model_names = "Base", coolors = c("#FB8B24", "#D90368", "#820263"))
...
# plot_density(SIR = list(sir_depensation1[[1]], sir_depensation1[[2]], sir_base2[[1]], sir_depensation1[[1]]),  file_name = file_name,  posteriors_lwd = c(3,1,3,3), posteriors_lty = c(1,1,2,1), posteriors_col = c(1,1,"grey45",1))
plot_ioa(sir_depensation1[[1]],  file_name = file_name, ioa_names = NULL )
summary_table(sir_depensation1[[1]],  file_name = file_name)
plot_suplus_prod(list(sir_depensation1[[1]], sir_depensation1[[2]], sir_base2[[1]]), file_name = file_name, model_names = c("Dep-1", "Dep-1 prior", "Base"), coolors = c("#FB8B24", "#D90368", "#820263"))
...
# plot_density(SIR = list(sir_depensation2[[1]], sir_depensation2[[2]], sir_base2[[1]], sir_depensation2[[1]]),  file_name = file_name,  posteriors_lwd = c(3,1,3,3), posteriors_lty = c(1,1,2,1), posteriors_col = c(1,1,"grey45",1))
plot_ioa(sir_depensation2[[1]],  file_name = file_name, ioa_names = NULL )
summary_table(sir_depensation2[[1]],  file_name = file_name)
plot_suplus_prod(list(sir_depensation2[[1]], sir_depensation2[[2]], sir_base2[[1]]), file_name = file_name, model_names = c("Dep-2", "Dep-2 prior", "Base"), coolors = c("#FB8B24", "#D90368", "#820263"))
...
# plot_density(SIR = list(sir_depensation3[[1]], sir_depensation3[[2]], sir_base2[[1]], sir_depensation3[[1]]),  file_name = file_name,  posteriors_lwd = c(3,1,3,3), posteriors_lty = c(1,1,2,1), posteriors_col = c(1,1,"grey45",1))
plot_ioa(sir_depensation3[[1]],  file_name = file_name, ioa_names = NULL )
summary_table(sir_depensation3[[1]],  file_name = file_name)
plot_suplus_prod(list(sir_depensation3[[1]], sir_depensation3[[2]], sir_base2[[1]]), file_name = file_name, model_names = c("Dep-3", "Dep-3 prior", "Base"), coolors = c("#FB8B24", "#D90368", "#820263"))
...
# plot_density(SIR = list(sir_depensation4[[1]], sir_depensation4[[2]], sir_base2[[1]], sir_depensation4[[1]]),  file_name = file_name,  posteriors_lwd = c(3,1,3,3), posteriors_lty = c(1,1,2,1), posteriors_col = c(1,1,"grey45",1))
plot_ioa(sir_depensation4[[1]],  file_name = file_name, ioa_names = NULL )
summary_table(sir_depensation4[[1]],  file_name = file_name)
plot_suplus_prod(list(sir_depensation4[[1]], sir_depensation4[[2]], sir_base2[[1]]), file_name = file_name, model_names = c("Dep-4", "Dep-4 prior", "Base"), coolors = c("#FB8B24", "#D90368", "#820263"))
...
# plot_density(SIR = list(sir_depensation5[[1]], sir_depensation5[[2]], sir_base2[[1]], sir_depensation5[[1]]),  file_name = file_name,  posteriors_lwd = c(3,1,3,3), posteriors_lty = c(1,1,2,1), posteriors_col = c(1,1,"grey45",1))
plot_ioa(sir_depensation5[[1]],  file_name = file_name, ioa_names = NULL )
summary_table(sir_depensation5[[1]],  file_name = file_name)
plot_suplus_prod(list(sir_depensation5[[1]], sir_depensation5[[2]], sir_base2[[1]]), file_name = file_name, model_names = c("Dep-1b", "Dep-1b prior", "Base"), coolors = c("#FB8B24", "#D90368", "#820263"))
...
# plot_density(SIR = list(sir_depensation6[[1]], sir_depensation6[[2]], sir_base2[[1]], sir_depensation6[[1]]),  file_name = file_name,  posteriors_lwd = c(3,1,3,3), posteriors_lty = c(1,1,2,1), posteriors_col = c(1,1,"grey45",1))
plot_ioa(sir_depensation6[[1]],  file_name = file_name, ioa_names = NULL )
summary_table(sir_depensation6[[1]],  file_name = file_name)
plot_suplus_prod(list(sir_depensation6[[1]], sir_depensation6[[2]], sir_base2[[1]]), file_name = file_name, model_names = c("Dep-2b", "Dep-2b prior", "Base"), coolors = c("#FB8B24", "#D90368", "#820263"))
...
# plot_density(SIR = list(sir_depensation7[[1]], sir_depensation7[[2]], sir_base2[[1]], sir_depensation7[[1]]),  file_name = file_name,  posteriors_lwd = c(3,1,3,3), posteriors_lty = c(1,1,2,1), posteriors_col = c(1,1,"grey45",1))
plot_ioa(sir_depensation7[[1]],  file_name = file_name, ioa_names = NULL )
summary_table(sir_depensation7[[1]],  file_name = file_name)
plot_suplus_prod(list(sir_depensation7[[1]], sir_depensation7[[2]], sir_base2[[1]]), file_name = file_name, model_names = c("Dep-3b", "Dep-3b prior", "Base"), coolors = c("#FB8B24", "#D90368", "#820263"))
...
# plot_density(SIR = list(sir_depensation8[[1]], sir_depensation8[[2]], sir_base2[[1]], sir_depensation8[[1]]),  file_name = file_name,  posteriors_lwd = c(3,1,3,3), posteriors_lty = c(1,1,2,1), posteriors_col = c(1,1,"grey45",1))
plot_ioa(sir_depensation8[[1]],  file_name = file_name, ioa_names = NULL )
summary_table(sir_depensation8[[1]],  file_name = file_name)
plot_suplus_prod(list(sir_depensation8[[1]], sir_depensation8[[2]], sir_base2[[1]]), file_name = file_name, model_names = c("Dep-4", "Dep-4b prior", "Base"), coolors = c("#FB8B24", "#D90368", "#820263"))
